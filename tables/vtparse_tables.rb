...
#    0x80..0x8f => [:execute, transition_to(:GROUND)], # 0x80..0xf7 are possible UTF-8 characters
...
$states[:OSC_STRING] = {
    :on_entry  => :osc_start,
    0x00..0x06 => :ignore,
    0x07       => transition_to(:GROUND), # Support for xterm's termination of OSC using BEL
    0x08..0x17 => :ignore,
    0x19       => :ignore,
    0x1c..0x1f => :ignore,
    0x20..0x7f => :osc_put,
